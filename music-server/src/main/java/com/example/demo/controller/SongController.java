...
public class SongController {
    ...
    public MultipartConfigElement multipartConfigElement() {
        ...
        factory.setMaxFileSize(String.valueOf(DataSize.of(10, DataUnit.MEGABYTES)));
        /// 设置总上传数据总大小10M
        factory.setMaxRequestSize(String.valueOf(DataSize.of(10, DataUnit.MEGABYTES)));
    ...
    public class MyPicConfig implements WebMvcConfigurer {
        ...
        public void addResourceHandlers(ResourceHandlerRegistry registry) {
            registry.addResourceHandler("/img/songPic/**").addResourceLocations("file:D:\\course\\music-website-master\\music-server\\data\\img\\songPic\\");
            registry.addResourceHandler("/song/**").addResourceLocations("file:D:\\course\\music-website-master\\music-server\\data\\song\\");
        }
    }
